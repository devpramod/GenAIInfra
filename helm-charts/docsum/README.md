...
# helm install docsum docsum -f docsum/variant_external-llm-values.yaml --set externalLLM.LLM_SERVICE_HOST_IP="http://your-llm-server" --set externalLLM.LLM_MODEL="your-model" --set externalLLM.OPENAI_API_KEY="your-api-key"
