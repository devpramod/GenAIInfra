#!/bin/bash
# Test script for ChatQnA with external-llm-values (failing case)

echo "==========================================="
echo "Testing ChatQnA with external-llm-values.yaml"
...
cd "$(dirname "$0")/../.."
exec ./ci-simulation/helm-chart-test.sh chatqna external-llm-values