#!/bin/bash
# Test script for DocSum with external-llm-values (failing case)

echo "==========================================="
echo "Testing DocSum with external-llm-values.yaml"
...
cd "$(dirname "$0")/../.."
exec ./ci-simulation/helm-chart-test.sh docsum external-llm-values